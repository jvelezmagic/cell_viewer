# Cell Viewer guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `cell_viewer/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `cell_viewer` folder and use the modules inside your notebooks :
...
```python
from cell_viewer.utils.paths import data_dir
data_dir()
```
